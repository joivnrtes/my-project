document.addEventListener('DOMContentLoaded', () => {
    ...
    fetchWithAuth(`http://localhost:3000/api/friend-request/${requestId}`)
      .then(result => {
        ...
        document.getElementById('avatar').src = fromUser.avatarUrl || 'http://localhost:3000/default-avatar.png';
